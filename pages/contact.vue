		...
		<div class="container mx-auto px-4 sm:px-24 mb-12 text-white/90">
			...
			<div class="mx-auto max-w-[40rem] mt-4 rounded-xl bg-gray-800/40 py-12 px-8">
				<form id="messform" @submit.prevent="submitForm">
					...
					<button type="submit" class="flex items-start gap-2 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center  bg-blue-600  hover:bg-blue-700  focus:ring-blue-800"> <p>{{ $t('page.contact.Form.btn') }}</p> <i class='mt-px bx bx-xs bx-send'></i></button>
