    ...
    <div class="w-full h-full flex justify-center items-center py-24">
        <div class="bg-gray-800/70 rounded-xl py-12 px-8">
            ...
            <div class="mt-4">
                ...
                >
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-400">{{ $t('page.update.new-email') }}</label>
                    <div class="flex mb-6">
                    ...
                    <label for="remail" class="block mb-2 text-sm font-medium text-gray-400">{{ $t('page.update.rnew-email') }}</label>
                    <div class="flex mb-4">
                        <span class="inline-flex items-center px-3 text-sm border border-r-0 rounded-l-md   bg-gray-600   text-gray-400   border-gray-600">
                            <i class='bx-xs w-4 h-4 text-gray-400 bx bxs-envelope'></i>
                        </span>
                        <input type="email" id="remail" v-model="remail"  placeholder="name@email.com" class="rounded-none rounded-r-lg 0 border block flex-1 min-w-0 w-full text-sm p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                    </div>
...
const update = async () => {
    ...
    if (email.value != remail.value) {
        errorstate.value = 'check the correctness of emails'
    } else{
