<template>
    <div>
        <div v-if="isSignUp" class="bg-gray-800/70 rounded-xl py-12 px-8">
            ...
            <div class="mb-4">
                <p class="text-gray-400">{{ $t('page.login.signupAnother') }}</p>
            ...
            <div class="mt-4">
                ...
                >
                    ...
                    <div class="flex mb-6">
                        <span class="inline-flex items-center px-3 text-sm border border-r-0rounded-l-md   bg-gray-600   text-gray-400   border-gray-600">
                    ...
                    <div>
                        <button class="w-full py-2 mt-4 bg-primary hover:bg-primary duration-150 text-white rounded-lg ">{{ $t('page.login.signupButton') }}</button>
                    </div>

                </form>
                <div class="text-gray-500 text-sm mt-4 text-center flex flex-col">
                    <button class="underline" @click="isSignUp = !isSignUp">{{ $t('page.login.haveacc') }}</button>
                </div>
            </div>
            </div>

        <div v-else class="bg-gray-800/70 rounded-xl py-12 px-8">
            ...
            <div class="mt-4">
                ...
                <div class="text-gray-500 text-sm mt-4 text-center flex flex-col">
                    ...
                    <button class="underline" @click="isSignUp = !isSignUp">{{ $t('page.login.donthave') }}</button>
                </div>
            </div>
        </div>
